...
export declare class SwaggerExplorer {
    ...
    exploreController(wrapper: InstanceWrapper<Controller>, applicationConfig: ApplicationConfig, modulePath?: string, globalPrefix?: string, operationIdFactory?: OperationIdFactory, linkNameFactory?: (controllerKey: string, methodKey: string, fieldKey: string) => string, autoTagControllers?: boolean): DenormalizedDoc[];
